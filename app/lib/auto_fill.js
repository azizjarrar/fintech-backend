...
const autoFill = async () => {
  ...
  const users = [
    ...
    { name: 'Madad Admin', email: 'admin@madad.com', password: 'AdminPass123', role: 'admin' },
    {
      ...
      lenderProfile: {
        programCode: 'P1a', creditScoreThreshold: 700, creditScoreMultiplierHigh: 1.5, creditScoreMultiplierLow: 1.0,
    ...
    },
    {
      ...
      lenderProfile: {
        programCode: 'P2', creditScoreThreshold: 700, creditScoreMultiplierHigh: 1.5, creditScoreMultiplierLow: 0.9,
    ...
    },
    {
      ...
      lenderProfile: {
        programCode: 'P3', creditScoreThreshold: 600, creditScoreMultiplierHigh: 1.25, creditScoreMultiplierLow: 1.0,
